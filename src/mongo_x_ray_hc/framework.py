...
CHECKLIST_CLASSES = load_classes("mongo_x_ray_hc.check_items")
...
class Framework(BaseFramework):
    ...
    def _render_markdown(self, output: TextIO) -> None:
        ...
        if risk_available:
            output.write(
                '| <span data-sortable="true">Category</span>{400} | <span data-sortable="true">Count</span>{100} | <span data-sortable="false">Known Risks</span>{150} |\n'
            )
            output.write("|---:|:---:|:---|\n")
        else:
            output.write(
